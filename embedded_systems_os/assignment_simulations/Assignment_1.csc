...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>unicast_sniffer</description>
      <source>[CONFIG_DIR]/../assignment_code/example_unicast.c</source>
      <commands>make example_unicast.cooja TARGET=cooja</commands>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype384</identifier>
      <description>rime_broadcaster_1</description>
      <source>[CONFIG_DIR]/../assignment_code/example-broadcast.c</source>
      <commands>make example-broadcast.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>76.62218539212189</x>
        <y>97.10404492567545</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>88.55818063312203</x>
        <y>73.16914151936952</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>93.83696006897428</x>
        <y>68.51507608280932</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype384</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>9.168613725171824 0.0 0.0 9.168613725171824 -588.8232063278334 -587.7837743479764</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
